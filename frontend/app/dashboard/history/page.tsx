    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5">
          <Link href="/dashboard/analysis">
            <Button
              variant="brand"
              className="h-9 px-4 text-xs font-bold bg-[#FF8066] hover:bg-[#ff6c4a] dark:bg-indigo-600 dark:hover:bg-indigo-500 text-white rounded-xl flex items-center gap-2 shadow-xs cursor-pointer"
            >
      ...
      {filteredHistory.length === 0 ? (
        <div className="bg-white border border-slate-200/80 rounded-2xl p-12 text-center shadow-2xs space-y-3">
          ...
          <div className="pt-2">
            <Link href="/dashboard/analysis">
              <Button variant="brand" className="h-8 px-4 text-xs font-bold bg-[#FF8066] hover:bg-[#ff6c4a] dark:bg-indigo-600 dark:hover:bg-indigo-500 text-white rounded-lg">
                Run First Analysis
              </Button>
            </Link>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-6 max-w-2xl w-full shadow-2xl space-y-5 max-h-[90vh] overflow-y-auto text-left">
            ...
            <div className="pt-3 border-t border-slate-100 flex items-center justify-between">
              ...
              <Button
                variant="brand"
                onClick={() => setIsModalOpen(false)}
                className="h-9 px-5 text-xs font-bold bg-[#FF8066] hover:bg-[#ff6c4a] dark:bg-indigo-600 dark:hover:bg-indigo-500 text-white rounded-xl"
              >
                Close
              </Button>
            </div>
